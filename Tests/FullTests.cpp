...
TEST(CREATE_TABLE, TEST_5) {
    clearDB();
    check_requests(
        {{"create table a(b int not null, c real unique, d varchar(100) primary key);",
          0, ""},
...
TEST(CREATE_TABLE, TEST_12) {
    ...
    check_requests(
        {{"create table a(b varchar(100) not null unique primary key);", 0, ""},
         {"show create table a;", 0,
          "CREATE TABLE a(\n    b varchar(100) primary key not null unique\n);\n"}},
        client);
}
...
TEST(SYNTAX, TEST_3) {
    clearDB();
    check_requests({{"CREATE TABLE TAB(F VARCHAR(100));", 0, ""}},
                   client);
}
...
//          "~~Exception 602:\n can't compare int and varchar(100).\n"
...
//          EXCEPTION2NUMB(exc::ExceptionType::set_data_type_mismatch),
//          "~~Exception 601:\n value c is not compatible with data type varchar(100).\n"
...
//    clearDB();
//    check_requests(
//        {{"create table a(a int not null, b real primary key, c varchar(100) unique);",
//          0, ""},
